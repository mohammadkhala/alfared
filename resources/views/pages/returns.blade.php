...
<div class="ls">
  ...
  <div class="ls-body">
    ...
    <div class="ls-highlight">
      <strong>مدة الإرجاع: 3 أيام</strong> من تاريخ استلام المنتج
    </div>
  </div>
</div>
...
<div class="ls">
  ...
  <div class="ls-body">
    <ul>
      ...
      <li>تم إرسال منتج خاطئ (مختلف عما طلبته)</li>
      <li>المنتج لم يُفتح وبحالته الأصلية مع جميع الملحقات</li>
      <li>يوجد كمية ناقصة أو منتجات مفقودة من الطلب</li>
    </ul>
  </div>
</div>
...
<div class="ls">
  ...
  <div class="ls-body">
    <ul>
      <li>مرور أكثر من 3 أيام على الاستلام</li>
      <li>المنتجات الغذائية أو القابلة للتلف</li>
      <li>المنتجات المستخدَمة أو المفتوحة (ما لم تكن معيبة)</li>
      <li>المنتجات التي تضررت بسبب سوء الاستخدام</li>
      <li>المنتجات المخصصة أو المطبوعة حسب الطلب</li>
      <li>مستلزمات النظافة الشخصية بعد فتح التغليف</li>
    </ul>
  </div>
</div>
...
<div class="ls">
  ...
  <div class="ls-body">
    <ul>
      <li><strong>الخطوة 1:</strong> تواصل معنا خلال 3 أيام من الاستلام عبر واتساب أو التطبيق</li>
      <li><strong>الخطوة 2:</strong> أرسل صوراً واضحة للمنتج مع توضيح المشكلة</li>
      <li><strong>الخطوة 3:</strong> سنراجع طلبك ونردّ عليك خلال 24 ساعة</li>
      <li><strong>الخطوة 4:</strong> بعد الموافقة، سيتم ترتيب استلام المنتج منك</li>
      <li><strong>الخطوة 5:</strong> يتم إتمام الاستبدال أو الاسترداد خلال 3–5 أيام عمل</li>
    </ul>
  </div>
</div>
...
<div class="ls">
  ...
  <div class="ls-body">
    ...
    <ul>
      ...
      <li>سنتحمل كامل تكلفة الاستبدال أو الإرجاع</li>
    </ul>
  </div>
</div>
